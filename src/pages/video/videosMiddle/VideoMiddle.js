...
import "../../home/Homemiddle/statusFeed/statusfeed.css";
import {
  AiOutlineSetting,
  AiFillLike,
  AiOutlineLike,
...
const VideoMiddle = () => {
  ...
  return (
    <>
      <section className="py-4 bg-white my-4 drop-shadow-lg rounded-md box-border ">
        {/* first part  */}
        ...
        <div className="flex justify-around items-center">
          {/* live video part  */}
          <div
            className="flex items-center cursor-pointer hover:bg-gray-100 px-10 py-1 rounded-md transition-all select-none"
          ...
          {/* upload photo part */}
          <div className="flex items-center cursor-pointer hover:bg-gray-100 px-10 py-1 rounded-md transition-all select-none">
        ...
        <div className="flex flex-row items-center pt-2 relative px-4">
          {/* user profile pic */}
          <div className="w-10 h-10 rounded-full">
            <input
              type="image"
